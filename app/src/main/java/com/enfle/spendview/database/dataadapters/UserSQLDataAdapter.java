...
import com.enfle.spendview.database.api.UserDataAdapter;
 ...
 */
@Singleton
public class UserSQLDataAdapter extends BaseSQLDataAdapter<User> implements UserDataAdapter, UserInfoContract {

    @Inject
    public UserSQLDataAdapter(BriteDatabase briteDatabase) {
