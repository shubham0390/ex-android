...
import com.enfle.spendview.member.ContactPickerAdapter;
...
/**
 */
public class AddMembersFragment extends MVPFragment<AddMemberPresenter> implements SearchView.OnQueryTextListener, AddUpdateExpenseView {
