...
package com.mmt.shubh.expensemanager.ui.mvp.lce;
...
public class LCEAnimator {
    ...
    /**
     * Show the empty view. No animations, because sometimes loading things is pretty fast (i.e.
     * retrieve data from memory cache).
     */
    public static void showEmptyView(@NonNull View loadingView, @NonNull View contentView,
    ...
    public static void showErrorView(@NonNull final View loadingView, @NonNull final View contentView,
                                     @NonNull final TextView errorView) {
